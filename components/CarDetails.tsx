                ...
                <Dialog as="div" className="relative z-50" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-6 sm:p-8 text-center">
                            ...
                            > 
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] transform rounded-2xl p-6! bg-white text-left shadow-xl transition-all flex flex-col overflow-hidden"> 
                                    <button
                                    type="button"
                                    onClick={closeModal}
                                    className="absolute top-4 right-4 z-10 w-fit p-2! bg-white rounded-full cursor-pointer"
                                    >
                                        <Image src="/close.svg" alt="cloose" width={20} height={20} className="object-contain "/>
                                    </button>
                                    ...
                                    <div className="flex-1 flex flex-col gap-2 px-6 pb-6 mt-4!">
                                        <h2 className='capitalize font-semibold text-xl mb-2!'>{car.make} {car.model}</h2>
                         
                                    <div className='mt-3 flex flex-wrap gap-4'>
                                            {Object.entries(car).map(([key, value])=>(
                                                <div className='justify-between flex items-center text-right gap-4 w-full' key={key}>
